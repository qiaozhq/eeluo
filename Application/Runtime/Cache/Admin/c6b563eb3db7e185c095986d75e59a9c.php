        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                  <option value='' >==请选择分类==</option>
                    <option value="1" <?php if($new["catid"] == 1): ?>selected<?php endif; ?>>公司新闻</option>
                    <option value="2"  <?php if($new["catid"] == 2): ?>selected<?php endif; ?>>行业动态</option>
                </select>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input value="<?php echo ($new["title"]); ?>" type="text" name="title" class="form-control" id="inputname" placeholder="请填写新闻标题">
              </div>
            </div>
            <div class="form-group">
              <label for="datevalue" class="col-sm-2 control-label">简介:</label>
              <div class="col-sm-5">
                <input value="<?php echo ($new["description"]); ?>" type="text" name="description" class="form-control" id="datevalue" placeholder="请填写新闻简介">
              </div>
            </div>                 
            <div class="form-group">
              ...
              <div class="col-sm-5">
                ...
                <img id="upload_org_code_img" width="150" height="150" src="<?php echo ($new["thumb"]); ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <textarea class="input js-editor" id="editor_singcms" name="content" rows="20" ><?php echo (str_replace('\"','',$new["content"])); ?></textarea>
              </div>
            </div>                                              
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="radio" name="status" id="optionsRadiosInline1" value="1" <?php if($new["status"] == 1): ?>checked<?php endif; ?>> 开启
                    <input type="radio" name="status" id="optionsRadiosInline2" value="0" <?php if($new["status"] == 0): ?>checked<?php endif; ?>> 关闭
                </div>                
            </div>
            <div class="form-group">
